...
MIMS está desplegado para usuarios de Claude Code CLI y Codex App, y consta de tres componentes principales: configuración de persona inyectada en el Agente principal (`CLAUDE.md` / `AGENTS.md`), flujo de trabajo estructurado (Skill) y sub-agentes que manejan tareas atómicas.
...
|------|-----------|---------------|
| Persona y Comportamiento Base | CLAUDE.md / AGENTS.md | Inyección T0 en el Agente principal, siempre activo |
...
│   ├── AGENTS.md                       # Persona MIMS (Codex, generado al instalar)
│   └── .claude/
│       ├── agents/
...
9. **R9 Entrega** - Entregar el prototipo, recopilar comentarios

**Salida**: `prototype/` (prototipo interactivo con workbench orientado a procesos y registro de comentarios de revisión)
...
**Leer Documentación**:
- Entender la arquitectura del proyecto desde `CLAUDE.md`
...
**Despliegue**:
- **Recomendado**: Usar el script de instalación (ver `impl/README.md`)
- **Manual**: Copiar el contenido del directorio `impl/` a la raíz del proyecto
- **Agente de IA**: Los agentes de IA pueden leer `impl/README.md` para auto-instalarse
